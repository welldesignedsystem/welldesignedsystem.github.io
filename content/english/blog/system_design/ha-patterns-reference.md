...
- **outbox pattern + SQS/SNS (or Kafka) + idempotent consumer.** - This removes synchronous coupling without needing full saga orchestration — save that for multi-step business transactions, not a two-hop propagation.
