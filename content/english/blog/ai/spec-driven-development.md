...
| **cc-sdd** (gotalab) | Spec-anchored, code-as-truth                      | None — 8 agents supported                                                         | Low — `npx cc-sdd@latest`                                                   | Via subagents, not native to the tool                                | Teams who want spec _contracts_ between components without treating the spec as the master document          | Moderate, actively developed                                                                          |
