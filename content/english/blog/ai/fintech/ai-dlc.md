...
- Source:
  - [AWS blog](https://aws.amazon.com/blogs/devops/ai-driven-development-life-cycle/) ("Both these approaches have produced suboptimal results... AI-DLC aims to address");
  - [Bitloops, AI as Co-Developer vs. Autonomous Agent](https://bitloops.com/resources/ai-native-development/ai-as-co-developer-vs-autonomous-agent) (spectrum from Autocomplete → Co-Developer → Supervised Agent → Autonomous Agent).
