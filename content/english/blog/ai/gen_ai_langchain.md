...
- **Design Pattern**: Follows _CQRS (Command Query Responsibility Segregation)_ principle separate write (doc updates) and read (retrieval) models for consistency.
